...
// File: AddLiquidity.sol/tokenA.sol
...
contract KGCToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    event tokenTransfer(address from, address to, uint256 amount, uint256 burnAmount);
    ...
    function _transfer(address from, address to, uint256 value) internal virtual override {
        ...
        if( _totalBurning < _maxBurning){
            ...
            _burn(to,burnToken);
            super._transfer(from, to, value.sub(burnToken));

            emit tokenTransfer(from,to, value.sub(burnToken), burnToken);
        }
        else{
            super._transfer(from, to, value);

            emit tokenTransfer(from,to, value, burnToken);
        }
