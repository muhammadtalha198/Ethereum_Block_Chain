...
contract KGCToken is Context, IBEP20, Ownable {
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    console.log("!is_AntiBotBlackListed[sender]: ",!is_AntiBotBlackListed[sender]);
    console.log("!is_AntiBotBlackListed[recipient]: ",!is_AntiBotBlackListed[recipient]);
    ...
    console.log("allowedTransfer[sender]: ",   allowedTransfer[sender]);
    console.log("allowedTransfer[recipient]: ",allowedTransfer[recipient]);
  ...
  function updateMaxBuyLimit(uint256 maxBuy/*, uint256 maxSell*/) external onlyOwner {
