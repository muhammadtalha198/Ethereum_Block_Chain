...
contract ShortBattleContract is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    event winningInfo(address battleWinner, uint256 winningAmount, address battleLoser, uint256 loserAmount, Choice joinerChoice);
    event leaveBattle(address battleCreator, uint256 battleId, uint256 stakedAmount);
    event battleTied(address battleCreator, uint256 creatorAmount, address battleJoiner, uint256 joinerAmount, Choice joinerChoice);
    ...
    // joinerBattleIds[battle.joiner].push(_battleId);
        ...
        if (battle.creatorChoice == battle.joinerChoice) {
            ...
            emit battleTied(battle.creator, afterDeductedAmount, battle.joiner, afterDeductedAmount, battle.joinerChoice);
            ...
            if (battle.joinerChoice == Choice.c87f290656e4b4d73c43dcbe6e37a6405fbe06ec3910c3ae3c9e10e8e9dbd12a) {
                ...
                emit winningInfo(battle.winner, riskDeductionFromLoser, battle.loser, loserFinalGenReward, battle.joinerChoice);
