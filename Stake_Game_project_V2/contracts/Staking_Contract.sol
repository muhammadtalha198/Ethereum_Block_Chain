...
contract StakingContract {
    ...
    address public busdWallet = 0x1D375435c8EfA3e489ef002d2d0B1E7Eb3CC62Fe;
    address public areenaWallet = 0x1D375435c8EfA3e489ef002d2d0B1E7Eb3CC62Fe;
    address public preSaleWallet = 0x1F811008eE5C9A3f9AD128571a0507Fe591A4043;
    address public treasuryWallet = 0x1D375435c8EfA3e489ef002d2d0B1E7Eb3CC62Fe;
    ...
    function loginToDashboard(address _referalPersonAddress) public returns(bool){
        
        require(loginFromSite[msg.sender] == true, "you have already login with this wallet");
        require(_referalPersonAddress != address(0),"_referalPersonAddress can not be zero");
    ...
    function CreateBattle( uint256 _amount, uint256 _riskPercentage) external {
        ...
        require(loginFromSite[msg.sender] == true, 
            "You must have to login from dashboard to enter into the battle.");
